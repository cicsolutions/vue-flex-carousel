<template>
  <div class="flex-carousel">
    ...
    <div class="m-6 flex fixed pin-b pin-l">
      ...
      <button v-on:click="previous" class="p-3 bg-blue text-white rounded mr-2">Prev</button>
      <button v-on:click="next" class="p-3 bg-blue text-white rounded mr-2">Next</button>
    </div>
  </div>
</template>
